  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!email || !emailRegex.test(email)) {
        errors.email = "Email is required and should have a valid format";
      }
          ...
          <form className="space-y-6" action="#" method="POST">
            <div className="flex space-x-4">
              <div className="flex-1">
                ...
                />
                {errors.firstname && (
                  <div className="text-red-300  font-bold ">{errors.firstname}</div>
                )}
              </div>
              <div className="flex-1">
                <label
            ...
            <div>
              ...
              />
              {errors.email && (
                <div className="text-red-300  font-bold ">{errors.email}</div>
              )}
            </div>
            ...
            <div>
              ...
              {errors.password && (
                <div className="text-red-300  font-bold ">{errors.password}</div>
              )}
            </div>
            ...
            <div>
              ...
              />
              {errors.phone && (
                <div className="text-red-300  font-bold ">{errors.phone}</div>
              )}
            </div>
